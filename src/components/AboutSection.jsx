        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl border border-yellow-200 hover:border-yellow-400 shadow-sm hover:shadow-md transition-all group">
              ...
              <h4 className="text-base font-extrabold text-slate-900">Nationwide Delivery</h4>
              <p className="mt-1.5 text-xs text-slate-600 leading-relaxed">
                Carefully packed and delivered anywhere in Egypt — shipping details confirmed with you on WhatsApp.
              </p>
            </div>
